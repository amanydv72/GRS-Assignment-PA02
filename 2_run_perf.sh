...
output_file="2_perf_results.csv"
...
for threads in "${thread_counts[@]}"; do
    ...
    LC_NUMERIC=C sudo perf stat -e cpu-clock,task-clock,L1-dcache-loads,L1-dcache-load-misses,cache-references,cache-misses,context-switches -o temp_perf_output.txt ./2_memory_bound $threads > /dev/null 2>&1
